...
public class ProfileValidator implements Validator {
    ...
    public void validate(Object object, Errors errors) {
        ...
        ValidationUtils.rejectIfEmpty(errors, "telephone", "profile.telephone.empty");
        ...
        if (!(telephonePattern.matcher(profile.getTelephone()).matches()) && !errors.hasFieldErrors("telephone")) {
            errors.rejectValue("telephone", "profile.telephone.invalid");
        }
        if (!(addressPattern.matcher(profile.getAddress()).matches()) && !errors.hasFieldErrors("telephone")) {
            errors.rejectValue("address", "profile.address.invalid");
        }
    }
}
